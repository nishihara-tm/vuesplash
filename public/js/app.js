        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                setData = this.photo.comments && this.photo.comments.length > 0 ? [response.data].concat(_toConsumableArray(this.photo.comments)) : [response.data];
                this.$set(this.photo, 'comments', setData);
      ...
      _c("div", { staticClass: "navbar__menu" }, [
        _vm.isLogin
          ? _c("div", { staticClass: "navbar__item" }, [
              _c(
                "button",
                { staticClass: "button", on: { click: _vm.handleClick } },
                [
    ...
    ? _c(
        ...
        [
          _c(
            ...
            [
              ...
              _c("figcaption", [
                _vm._v(
                  "Posted by " +
                    _vm._s(_vm.photo.owner ? _vm.photo.owner.name : "")
                )
              ])
            ]
          ),
          ...
          _c("div", { staticClass: "photo-detail__pane" }, [
            ...
            _vm._m(0),
            _vm._v(" "),
            _vm.photo.comments && _vm.photo.comments.length > 0
              ? _c(
                  "ul",
...
__webpack_require__(/*! /Users/nishiharahiroto/git/laravel-app/vuesplash/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/nishiharahiroto/git/laravel-app/vuesplash/resources/sass/app.scss */"./resources/sass/app.scss");
